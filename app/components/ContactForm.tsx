      ...
      <section className=' mt-8 sm:mt-12 md:mt-16'>
          <div className='flex flex-col items-center justify-center min-h-screen p-10 md:p-16 xl:p-28 '>
              ...
              <div className='container flex items-center justify-center '>
                  <form className='grid grid-cols-1 sm:grid-cols-2 gap-4 p-6 rounded-lg sm:w-3/4 md:w-1/2 text-stone-800 w-full max-w-lg border-2 border-stone-800 bg-stone-950'>
